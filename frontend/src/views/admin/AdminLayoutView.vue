    ...
    <el-container>
      <el-header class="header">
        ...
        <span class="right_tool">
          <a href="javascript:0" @click="switchToChat" class="chat-btn" aria-label="聊天" title="聊天">
        ...
        <el-aside width="200px" class="aside" :class="{ 'is-mobile-open': navigationOpen }">
          ...
          <el-menu router @select="navigationOpen = false">
            ...
            <el-menu-item index="role">
              <el-icon><Service /></el-icon> 角色管理
            </el-menu-item>

            <el-menu-item index="knowledgeBase">
              <el-icon><Notebook /></el-icon> 知识库管理
            </el-menu-item>

            <el-menu-item index="announcement">
               <el-icon><Message /></el-icon> 公告管理
            </el-menu-item>

            <el-menu-item index="session">
              <el-icon><ChatSquare /></el-icon> 会话管理
            </el-menu-item>
          </el-menu>
        </el-aside>
