...
| 返回值 | 说明 |
| --- | --- |
| `data` | 上传结果，status 为 pending（待后台 Worker 索引） |
...
#### 11.3 `GET` /api/document/status/{document_id}
...
#### 11.4 `POST` /api/document/reindex/{document_id}
...
#### 11.5 `GET` /api/document/{document_id}
...
#### 11.6 `DELETE` /api/document/{document_id}
...
#### 11.7 `GET` /api/document/knowledge_base/{knowledge_base_id}
...
| `application/json` | 是 | `is_malicious` | 否 | integer | minimum=0.0, maximum=1.0, default=0 |
| `application/json` | 是 | `is_stopped` | 否 | integer | minimum=0.0, maximum=1.0, default=0 |
...
| `is_malicious` | 否 | integer | minimum=0.0, maximum=1.0, default=0 |
| `is_stopped` | 否 | integer | minimum=0.0, maximum=1.0, default=0 |
