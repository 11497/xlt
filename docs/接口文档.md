...
| `application/json` | 是 | `is_deleted` | 否 | integer | minimum=0.0, maximum=1.0, default=0 |
| `application/json` | 是 | `deleted_at` | 否 | string \| null |  |
...
| `id` | 否 | integer \| null |  |
| `is_deleted` | 否 | integer | minimum=0.0, maximum=1.0, default=0 |
| `deleted_at` | 否 | string \| null |  |
