...
class ChatService:
    ...
    def __init__(
            ...
            utility_top_p: float = UTILITY_CONFIG["TOP_P"],
            utility_frequency_penalty: float = UTILITY_CONFIG["FREQUENCY_PENALTY"],
            utility_presence_penalty: float = UTILITY_CONFIG["PRESENCE_PENALTY"]
    ):
        """
        初始化聊天服务
        ...
        self.utility_llm = ChatOpenAI(
            ...
            top_p=utility_top_p,
            frequency_penalty=utility_frequency_penalty,
            presence_penalty=utility_presence_penalty
        )
